/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    /***/ 999: /***/ (
      ...
      var SmoothScroll_default =
        /*#__PURE__*/ __webpack_require__.n(SmoothScroll); // CONCATENATED MODULE: ./javascript/quiz.js
      ...
      function initClock(finishDate) {
        ...
        function launchClock() {
          ...
          hoursElement.innerHTML =
            '                        \n            <span class="quizTimer__item">'
              .concat(
                hhToString[0],
                '</span>\n            <span class="quizTimer__item">'
              )
              .concat(hhToString[1], "</span>\n        ");
      ...
      function initFormsQuiz() {
        ...
        var elements = _toConsumableArray(
          parent.querySelectorAll("[data-quiz-stage]")
      ...
      var renderer = __webpack_require__(7645); // CONCATENATED MODULE: ./index.js
      function index_createForOfIteratorHelper(o, allowArrayLike) {
        var it =
          (typeof Symbol !== "undefined" && o[Symbol.iterator]) ||
          o["@@iterator"];
        if (!it) {
          if (
            Array.isArray(o) ||
            (it = index_unsupportedIterableToArray(o)) ||
            (allowArrayLike && o && typeof o.length === "number")
          ) {
            if (it) o = it;
            var i = 0;
      ...
      function index_toConsumableArray(arr) {
        return (
          index_arrayWithoutHoles(arr) ||
          index_iterableToArray(arr) ||
          index_unsupportedIterableToArray(arr) ||
          index_nonIterableSpread()
        );
      }

      function index_nonIterableSpread() {
        throw new TypeError(
          "Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."
        );
      }

      function index_unsupportedIterableToArray(o, minLen) {
        if (!o) return;
        if (typeof o === "string") return index_arrayLikeToArray(o, minLen);
        var n = Object.prototype.toString.call(o).slice(8, -1);
        if (n === "Object" && o.constructor) n = o.constructor.name;
        if (n === "Map" || n === "Set") return Array.from(o);
        if (
          ...
          return index_arrayLikeToArray(o, minLen);
      }

      function index_iterableToArray(iter) {
        if (
          (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null) ||
          iter["@@iterator"] != null
        )
      ...
      function index_arrayWithoutHoles(arr) {
        if (Array.isArray(arr)) return index_arrayLikeToArray(arr);
      }

      function index_arrayLikeToArray(arr, len) {
        if (len == null || len > arr.length) len = arr.length;
        for (var i = 0, arr2 = new Array(len); i < len; i++) {
          arr2[i] = arr[i];
        }
      ...
      function parallax(event) {
        ...
        rabbits.style.transform = "translateY(".concat(
          rabbitsValue,
          "px) translateX(-50%)"
        );
      ...
      function totalInit() {
        var items = index_toConsumableArray(
          document.querySelectorAll(".total-item__content.fadein")
        );
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
              ...
              var currentElementPosition =
                window.pageYOffset + window.innerHeight - elementBottom;
      ...
      function faqInit() {
        ...
        var _iterator2 = index_createForOfIteratorHelper(
              ...
              },
              {
                set: function set(target, prop, value) {
                  if (prop === "active") {
                    ...
                    if (value === true) {
                      target.content.style.height =
                        target.content.scrollHeight + "px";
      ...
      function cloneElement() {
        var _iterator3 = index_createForOfIteratorHelper(
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
            ...
            var elementToClone = document.querySelector(
      ...
      frameByFrameCanvases.forEach(function (framesContainer) {
        ...
        animationHandlers.push(function () {
          var timeline =
            renderer /* default.getElementCoords */.Z.getElementCoords(
              framesContainer
            ).height +
            renderer /* default.getElementCoords */.Z.getElementCoords(
              framesContainer
          ...
          var scrollCoord =
            renderer /* default.getScrollCoordsFromElement */.Z.getScrollCoordsFromElement(
              framesContainer
            ).windowBottom.fromBetweenTopMiddle;
      ...
      var progressContent = Array.from(
        document.querySelectorAll(".progress__content")
      );
      var progressContentImg = Array.from(
        document.querySelectorAll(".progress__content .hovered-video")
      );
      var timeout = null;
      animationHandlers.push(function () {
        progressContent.forEach(function (content, idx) {
          var _Renderer$getMouseWin =
              renderer /* default.getMouseWindowCoords */.Z.getMouseWindowCoords(),
            x = _Renderer$getMouseWin.x,
            y = _Renderer$getMouseWin.y;

          var progressScrollTop =
            renderer /* default.getScrollCoordsFromElement */.Z.getScrollCoordsFromElement(
              progress
            ).windowTop.fromTop;
          ...
          if (
            ...
            renderer /* default.getElementCoords */.Z.getElementCoords(progress)
              .bottom
          ) {
            progressContentImg[idx].style.transform = "translate("
              .concat(x + progressScrollTop, "px, ")
              .concat(Math.min(y + progressScrollTop, y), "px)");
          } else {
            progressContentImg[idx].style.transform = "translate("
              .concat(x + progressScrollTop, "px, ")
              .concat(
          ...
          if (
            renderer /* default.isElementHovered */.Z.isElementHovered(content)
          ) {
      ...
      var progressFlowContainer = document.querySelector(
        ".progress__flow-container"
      );
      animationHandlers.push(function () {
        var progressFlowContainerCoords =
          renderer /* default.getElementCoords */.Z.getElementCoords(
            progressFlowContainer
          );

        if (
          progressFlowContainerCoords.width !== parseInt(progress.style.height)
        ) {
          progress.style.height = "".concat(
            progressFlowContainerCoords.width + window.innerHeight / 2,
            "px"
          );
        }

        if (
          renderer /* default.isElementVisible */.Z.isElementVisible(progress)
        ) {
          var progressScrollTop =
            renderer /* default.getScrollCoordsFromElement */.Z.getScrollCoordsFromElement(
              progress
            ).windowTop.fromTop;
          progressFlowContainer.style.transform = "translateX(".concat(
            -progressScrollTop,
            "px)"
          );
        }
      ...
      var el12 = {
        ...
        contentPhase1: document.querySelectorAll(
          ".roadmap .-phase12 .roadmap__content-block"
        )[0],
        contentPhase2: document.querySelectorAll(
          ".roadmap .-phase12 .roadmap__content-block"
        )[1],
        rocketTop: document.querySelectorAll(
          ".roadmap .-phase12 .canvas img"
        )[0],
        earth: document.querySelectorAll(".roadmap .-phase12 .canvas img")[1],
        moon: document.querySelectorAll(".roadmap .-phase12 .canvas img")[2],
        rocketSmall: document.querySelectorAll(
          ".roadmap .-phase12 .canvas img"
        )[3],
      ...
      var el3 = {
        contentPhase: document.querySelector(
          ".roadmap .-phase3 .roadmap__content-block"
        ),
        ...
        planetShard: document.querySelectorAll(
          ".roadmap .-phase3 .canvas img"
        )[3],
      };
      var el4 = {
        contentPhase: document.querySelector(
          ".roadmap .-phase4 .roadmap__flow-container"
        ),
        collectionImage1Wrapper: document.querySelectorAll(
          ".roadmap .-phase4 .slider .collection"
        )[0],
        collectionImage2Wrapper: document.querySelectorAll(
          ".roadmap .-phase4 .slider .collection"
        )[1],
        collectionImage3Wrapper: document.querySelectorAll(
          ".roadmap .-phase4 .slider .collection"
        )[2],
        collectionImage1: document.querySelectorAll(
          ".roadmap .-phase4 .slider .collection img"
        )[0],
        collectionImage2: document.querySelectorAll(
          ".roadmap .-phase4 .slider .collection img"
        )[1],
        collectionImage3: document.querySelectorAll(
          ".roadmap .-phase4 .slider .collection img"
        )[2],
        saturn: document.querySelectorAll(".roadmap .-phase4 .canvas img")[0],
        planetZoomed: document.querySelectorAll(
          ".roadmap .-phase4 .canvas img"
        )[1],
      }; // uppingShips: document.querySelectorAll('.roadmap .-phase4 .canvas img')[1],

      animationHandlers.push(function () {
        var roadmapScrollTop =
          renderer /* default.getScrollCoordsFromElement */.Z.getScrollCoordsFromElement(
            roadmap
          ).windowBottom.fromTop;

        if (
          renderer /* default.isElementVisible */.Z.isElementVisible(roadmap)
        ) {
      ...
      function transitionPhase12(roadmapScrollTop) {
        if (
          ...
          renderer /* default.getElementCoords */.Z.getElementCoords(
            ...
            renderer /* default.getElementCoords */.Z.getElementCoords(roadmap)
              .top +
            window.innerHeight / 2
        ) {
          el12.title.style.transform = "translate3d(0, "
            .concat(roadmapScrollTop / 10, "px, 0) scale(")
            .concat(1 - roadmapScrollTop / 30000, ")");
          el12.rocketTop.style.transform = "translate3d(0, "
            .concat(-roadmapScrollTop / 3, "px, 0) scale(")
            .concat(1 + roadmapScrollTop / 10000, ")");
          el12.moon.style.transform = "translate3d(0, ".concat(
            -roadmapScrollTop / 4,
            "px, 0)"
          );
          el12.earth.style.transform = "translate3d("
            .concat(roadmapScrollTop / 10, "px, ")
            .concat(roadmapScrollTop / 7, "px, 0) scale(")
            .concat(1 - roadmapScrollTop / 5000, ")");
          el12.contentPhase1.style.transform = "translate3d(0, "
            .concat(roadmapScrollTop / 10, "px, 0) scale(")
            .concat(Math.min(0.7 + roadmapScrollTop / 5000, 1), ")");
          el12.contentPhase2.style.transform = "translate3d(0, "
            .concat(roadmapScrollTop / 8, "px, 0) scale(")
            .concat(Math.min(0.65 + roadmapScrollTop / 5000, 1), ")");
          el12.rocketSmall.style.transform = "translate3d("
            .concat(roadmapScrollTop / 5, "px, ")
            .concat(-roadmapScrollTop, "px, 0)");
          el12.hare.style.transform = "translate3d("
            .concat(roadmapScrollTop / 4, "px, ")
            .concat(-roadmapScrollTop / 4, "px, 0) scale(")
            .concat(Math.min(0.65 + roadmapScrollTop / 3000, 4), ") rotate(")
            .concat(roadmapScrollTop / 4, "deg)");
          el12.plate1.style.transform = "translate3d("
            .concat(roadmapScrollTop / 7, "px, 0, 0) scale(")
            .concat(1 + roadmapScrollTop / 10000, ")");
          el12.plate2.style.transform = "translate3d("
            .concat(-roadmapScrollTop / 7, "px, ")
            .concat(-roadmapScrollTop / 7, "px, 0)");
        }
      }
      ...
      function transitionPhase3(roadmapScrollTop) {
        if (
          ...
          el3.contentPhase.style.transform = "translate3d(0, ".concat(
            resetedRoadmapScrollTop / 5,
            "px, 0)"
          );
          el3.rubbish.style.transform = "translate3d(0, ".concat(
            -roadmapScrollTop / 15,
            "px, 0)"
          );
          el3.ship.style.transform = "translate3d(0, "
            .concat(-roadmapScrollTop / 5, "px, 0) scale(")
            .concat(3.25 - roadmapScrollTop / 2000, ")");
          el3.planetShard.style.transform = "translate3d("
            .concat(roadmapScrollTop / 20, "px, ")
            .concat(roadmapScrollTop / 20, "px, 0)");
        }
      }
      ...
      function transitionPhase4(roadmapScrollTop) {
        if (
          ...
          el4.contentPhase.style.transform = "translate3d(0, ".concat(
            resetedRoadmapScrollTop / 5,
            "px, 0)"
          );
          ...
          if (window.innerWidth > 750) {
            ...
            el4.collectionImage2Wrapper.style.transform =
              "translate3d(0, ".concat(
                Math.max(700 - resetedRoadmapScrollTop / 2, 0),
                "px, 0)"
              );
            el4.collectionImage3Wrapper.style.transform =
              "translate3d(0, ".concat(
                Math.max(600 - resetedRoadmapScrollTop / 2, 0),
                "px, 0)"
              );
          } else {
            el4.collectionImage1Wrapper.style.transform =
              "translate3d(0, 0, 0)";
            el4.collectionImage2Wrapper.style.transform =
              "translate3d(0, 0, 0)";
            el4.collectionImage3Wrapper.style.transform =
          ...
          el4.collectionImage1Wrapper.style.maxHeight = "".concat(
            resetedRoadmapScrollTop / 3.25,
            "px"
          );
          el4.collectionImage2Wrapper.style.maxHeight = "".concat(
            resetedRoadmapScrollTop / 3.25,
            "px"
          );
          el4.collectionImage3Wrapper.style.maxHeight = "".concat(
            resetedRoadmapScrollTop / 3.25,
            "px"
          );
          el4.collectionImage1.style.transform = "scale(".concat(
            Math.max(2 - resetedRoadmapScrollTop / 1500, 1),
            ")"
          );
          el4.collectionImage2.style.transform = "scale(".concat(
            Math.max(2 - resetedRoadmapScrollTop / 1500, 1),
            ")"
          );
          el4.collectionImage3.style.transform = "scale(".concat(
            Math.max(2 - resetedRoadmapScrollTop / 1500, 1),
            ")"
          );
          el4.planetZoomed.style.transform = "translate3d(0, ".concat(
            -resetedRoadmapScrollTop / 5,
            "px, 0)"
          );
          el4.saturn.style.transform = "translate3d("
            .concat(-resetedRoadmapScrollTop / 5, "px, ")
            .concat(-resetedRoadmapScrollTop / 10, "px, 0)");
        }
      }
    ...
    /***/ 7645: /***/ (__unused_webpack_module, exports) => {
      "use strict";
      ...
      var _default = {
          ...
          return {
            windowTop: {
              ...
              fromBetweenMiddleBottom:
                window.scrollY - (b.bottom - b.height / 4),
        ...
        isElementVisible: function isElementVisible(a) {
          ...
          return (
            ...
            b.top <= window.scrollY + window.innerHeight
          );
        },
    ...
    /***/ 7353: /***/ (
      ...
      if (true) {
        // 1653862656055
        var cssReload = __webpack_require__(2826)(module.id, {
          publicPath: "../",
          locals: false,
        });
  ...
  /******/ __webpack_require__.O(undefined, [369], () =>
